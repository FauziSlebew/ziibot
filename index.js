    ...
    jobotz.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                  jobotz.sendMessage(anu.id, { image: { url: pp_user }, contextInfo: { mentionedJid: [num] }, caption: `𝘏𝘢𝘭𝘰 𝘉𝘦𝘣𝘢𝘯 🗿 𝘚𝘦𝘭𝘢𝘮𝘢𝘵 𝘋𝘢𝘵𝘢𝘯𝘨 𝘋𝘪 𝘎𝘳𝘰𝘶𝘱, 𝘑𝘢𝘯𝘨𝘢𝘯 𝘚𝘰𝘬𝘦𝘳 𝘠𝘢 𝘋𝘦𝘬😱${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
                                      })
                    
                } else if (anu.action == 'remove') {
                  jobotz.sendMessage(anu.id, { image: { url: pp_user }, contextInfo: { mentionedJid: [num] }, caption: `𝘉𝘺𝘦 𝘔𝘰𝘯𝘺𝘦𝘵 𝘎𝘢 𝘜𝘴𝘢𝘩 𝘑𝘰𝘪𝘯 𝘓𝘢𝘨𝘪 𝘠𝘢🤡${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
                                      })
